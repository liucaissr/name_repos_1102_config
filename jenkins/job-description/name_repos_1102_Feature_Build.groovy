...
def jslAppGeneral = lib.de.allianz.app.BuildGeneral.new()
    ...
    stage('Prepare') {
      steps {
        ...
        script {
          ...
          jslGit.checkout( config, "liucaissr", "name_repos_1102", branch_name)
          }
        }
      }
stage('Build') {
...
"""
def job = pipelineJob("name_repos_1102_Feature_Build");
...
job.with {
  properties {
    ...
    authenticationToken('4X2t52oEe6wGSkQtIdKrW2DLISDtRxht')
